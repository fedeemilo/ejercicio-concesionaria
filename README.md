# Resolución de ejercicio Concesionaria para empresa OnReady

## Instrucciones

- No se require instalar ninguna librería externa (sólo se necesita NodeJS)
- En terminal: git clone https://github.com/fedeemilo/ejercicio-concesionaria.git
- cd ejercicio-concesionaria
